...
export function ContractListPage(props: ContractListPageProps) {
      ...
      convertQueryToPrismaUtil(
        {
          ...
          searchTermKeys: ['contract_status.contains'],
          ...params.filters,
        },
        'contract',
      ),
  ...
  const columns: ColumnType[] = [
    { id: 'contract_status', header: 'Contract Status', accessorKey: 'contract_status' },
    { id: 'contract_duration', header: 'contract_duration', accessorKey: 'contract_duration' },
