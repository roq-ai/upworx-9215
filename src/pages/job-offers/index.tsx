  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['company', 'contract.count', 'job_application.count'],
          searchTerm: params.searchTerm,
          searchTermKeys: ['salary_range.contains', 'job_description.contains'],
          ...params.filters,
        },
        'job_offer',
      ),
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('job_application', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          accessorKey: 'job_application',
          cell: ({ row: { original: record } }: any) => record?._count?.job_application,
        }
      : null,
